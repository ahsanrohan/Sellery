...
namespace Web.Twitter.API
{
    public class TwitterRestApiHelper : MonoBehaviour
    {
        ...
        //https://developer.twitter.com/en/docs/tweets/timelines/api-reference/get-statuses-user_timeline.html
        public async static Task<Tweet[]> GetLatestTweetsFromUserByScreenName(string screenName, string accessToken, int maximumTweetsToGet = 100, bool includeRetweets = false)
        {
